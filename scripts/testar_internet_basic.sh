...
# Lista de sites que não filtram pings 2>&1 | tee -a "$tempfile2"
echo "speedtest.net" 2>&1 | tee -a "$tempfile2"
echo "www.pingtest.net" 2>&1 | tee -a "$tempfile2"
echo "checkip.dyndns.org" 2>&1 | tee -a "$tempfile2"
echo "mail.google.com" 2>&1 | tee -a "$tempfile2"
